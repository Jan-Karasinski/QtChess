...
bool Pawn::goodMove() {
    if(pos().x() + 0.5*BoardSizes::FieldWidth < 0 ||
      (pos().x() + 0.5*BoardSizes::FieldWidth > BoardSizes::BoardWidth) ||
       pos().y() + 0.5*BoardSizes::FieldHeight < 0 ||
      (pos().y() + 0.5*BoardSizes::FieldHeight > BoardSizes::BoardHeight))
        return false;
